...
import { CreateUser, UserObject } from "../../../stores/users/interfaces";
...
const props = defineProps<ManageUserFormProps>();

const usersStore = useUsersStore();

const user: Ref<UserObject | undefined> = ref();
...
const onUpdateClick = async (value: boolean) => {
  ...
  if (formIsValid.value) {
    emits("close-modal", value);
    await usersStore.updateUser({ ...createUserPayload() }, props.userId);
  }
};
</script>
